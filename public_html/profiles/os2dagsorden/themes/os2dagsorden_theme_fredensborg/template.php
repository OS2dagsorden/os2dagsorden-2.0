...
function os2dagsorden_theme_fredensborg_preprocess_page(&$variables) {
	...
	drupal_add_css(drupal_get_path('theme', 'os2dagsorden_theme_fredensborg') . '/css/ie.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'lt IE 9', '!IE' => FALSE), 'preprocess' => FALSE));
        if (variable_get('os2dagsorden_show_search_block_title', 'true')==='false')
            drupal_add_js('hide_search_block_title_fredensborg()', 'inline');
        /*
