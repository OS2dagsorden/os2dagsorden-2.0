...
((function () {
    ...
    Annotator.Plugin.Touch = a = function (a) {
        ...
        return d(g, c), f = Annotator._t, e = Annotator.$, a = Annotator.Plugin.Touch, g.prototype.events = {
            ...
            return this.quote.addClass(this.classes.expand), this.quote.find("button").text(f("Skjul")), this
        }, g.prototype.hideQuote = function () {
            return this.quote.removeClass(this.classes.expand), this.quote.find("button").text(f("Vis")), this
